...
<a type="button" data-bs-toggle="modal" data-bs-target="#komentar<?php echo $data['fotoid'] ?>">
      ...
      <?php
                    ...
                    if (mysqli_num_rows($cekbatalsuka) == 1) { ?>
                      <a href="../config/proses_unlike.php?fotoid=<?php echo $data ['fotoid'] ?>" type="submit" name="batalsuka"><i class="fa fa-thumbs-down "></i></a>

                    <?php } else { ?>
                      <a href="../config/proses_unlike.php?fotoid=<?php echo $data ['fotoid'] ?>" type="submit" name="suka"><i class="fa-regular fa-thumbs-down "></i></a>
                ...
                <div class="sticky-bottom">
                  <form action="../config/proses_komentar.php" method="POST">
                    <div class="input-group">
                      ...
                      <button type="submit" name="kirimkomentar" class="btn btn-outline-success "><i class="fa-regular fa-paper-plane" style="color: black;"></i></button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-left">
                 <br><a href="download.php?filename=<?php echo $data['lokasifile']; ?>" class="class"><i class="fa-solid fa-download fa-xl"></i></a>
                 </div>
              </div>
            </div>
...
<footer class="d-flex justify-content-center fixed-bottom" style="font-weight: bold; color: black;">
